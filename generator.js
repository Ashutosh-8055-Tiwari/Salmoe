...
const sitemap = template.replace(/__NEXT_PUBLIC_BASE_URL__/g, base_url).replace(/LAST_MODIFIED/g, new Date().toISOString().slice(0, 19).concat("+00:00"));
...
const robotsTxt = robotsTemplate.replace(/__NEXT_PUBLIC_BASE_URL__/g, base_url);
