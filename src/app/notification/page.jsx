...
const Notification = () => {
  ...
  return (
    <>
        ...
        <Head>
            <title>{t("notification")} - Kashmirt Trout</title>
        </Head>
        ...
        <div className='notification'>
          {/* <div className='cover'>
            ...
            <div className='title'>
              ...
              <span><Link href="/" className='text-light text-decoration-none'>{t("home")} / </Link></span><span className='active'>{t("notification")}</span>
            </div>
          </div> */}
          {notification === null
            ? (
                  ...
                  <div className="notifications">
                    ...
                    {notification.length === 0
                      ? (<div className='notification-body no-notification'>
                        <img src={No_Notification.src} className='no-data-img' alt='no-notification'></img>
