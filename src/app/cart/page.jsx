...
const ViewCart = () => {
    ...
    console.log('cart products', path)

    useEffect(() => {
        if (path == "/cart" && cart?.isGuest === false) {
        ...
        } else if (path == "/cart" && cart?.isGuest === true && cart?.guestCart?.length !== 0) {
            fetchGuestCart();
        } else if (path == "/cart" && cart?.isGuest === true && cart?.guestCart?.length === 0) {
            setiscartEmpty(true);
        }
    ...
    useEffect(() => {
        if (path == "/cart" && cart?.isGuest === true) {
            fetchGuestCart();
        }
    }, []);
    ...
    const stockValidation = () => {
        cart.cart?.data?.cart.forEach(element => {
            ...
            navigate.push(`${base_url}/checkout`);
        });
    };
    ...
    return (
        <>
        <Head>
            <title>{t("cart")} - Kashmirt Trout</title>
        </Head>
            {!isNetworkError ?
                <section id='viewcart' className='viewcart'>
                    {/* <div className='cover'>
                        ...
                        <div className='title'>
                            <h3>{t("cart")}</h3>
                            <span><Link href='/' className='text-light text-deco text-decoration-none'>{t("home")} / </Link></span><span className='active'>{t('cart')}</span>
                        </div>
                                        ...
                                        <div className="row justify-content-center">
                                            ...
                                            <div className='viewcart-product-wrapper col-8'>
                                                ...
                                                <table className='products-table table'>
                                                    <thead>
                                                        <tr>
                                                            <th className=' fs-5 first-column'>{t("product")}</th>
                                                            <th className=' fs-5 hide-mobile'>{t("unit")}</th>
                                                            <th className='fs-5'>{t("price")}</th>
                                                            <th className='fs-5'>{("quantity")}</th>
                                                            <th className=' fs-5 hide-mobile'>{t("sub_total")}</th>
                                                            <th className=' fs-5 last-column'>{t("remove")}</th>
                                                        </tr>
                                                    </thead>
                                                                    ...
                                                                    <tr key={index} className={`${!product.status ? "danger" : ""}`}>
                                                                        ...
                                                                        <th className='remove last-column'>
                                                                            <button
                                                                                ...
                                                                                <RiDeleteBinLine fill='red' fontSize={'2rem'} />
                                                                            </button>
                                                                        </th>
                                                                    </tr>
                                                                );
                                            ...
                                            <div className="billing col-3">
                                                ...
                                                <div className='cart-summary-wrapper'>
                                                    <div className='heading '>
                                                        <span className='text-black' >{t("cart")} {t("total")}</span>
                                                    </div>
                                                        ...
                                                        : (
                                                            <div className='summary'>
                                                                <div className='d-flex justify-content-between'>
                                                                    ...
                                                                    <div className='d-flex align-items-center wallet-currency'>
                                                                        {setting.setting && setting.setting.currency}
                                                                        <span>{
                                                                            cart?.isGuest === false ?
