...
import banner from "../../../public/checkout-banner.png"
...
import InjectCheckout from '../../components/checkout/StripeModal';
...
const Checkout = () => {
    ...
    return (
        ...
        <Head>
            <title>{t("checkout")} - Kashmirt Trout</title>
        </Head>
            {!isNetworkError ?
                <>
                    <section id='checkout'>
                        ...
                        <div className='cover '>
                            <img src={banner.src} onError={placeHolderImage} className='img-fluid ' alt="cover"></img>
                            {/* <div className='title'>
                                <h3>{t("checkout")}</h3>
                                <span><Link href="/" className="text-white text-decoration-none">{t("home")} / </Link> </span><span className='active'>{t("checkout")}</span>
                            </div> */}
                        </div>
    ...
    <div className='d-flex justify-content-center pt-3 calendarContainer'>
...
{/* Time Component - Conditional Rendering */}
{expectedDate && expectedDate.toString() !== "Invalid Date" && (
                ...
                : (
                    <>
                        {timeslots?.time_slots
                            .filter((element) => checkLastOrderTime(element?.last_order_time))
                            .map((timeslot, index) => (
                                <div 
                                key={index} 
                                className={`time-slot-container ${expectedTime?.title === timeslot?.title ? 'selected' : 'unselected'}`}
                            >
                                <div>
                                    <input 
                                        type="radio" 
                                        ...
                                        onChange={() => setexpectedTime(timeslot)} 
                                    />
                                </div>
                                                ...
                                                <div className='payment-wrapper checkout-component'>
                                                    ...
                                                    {setting?.payment_setting?.midtrans_payment_method === "1" ?
                                                        <label className="form-check-label cursorPointer" htmlFor='midtrans'>
                                                            <div className='payment-selector'>
                                                                <img src={Midtrans.src} alt='midtrans' />
                                                                <div className="">
                                                    ...
                                                    {setting?.payment_setting?.phonepay_payment_method === "1" ?
                                                        <label className="form-check-label cursorPointer" htmlFor='phonepe'>
                                                            <div className='payment-selector'>
                                                                <img src={PhonepeSVG.src} alt='phonepe' />
                                                                <div className="">
                                                                    <span>{t("phonepe")}</span>
                                                                </div>
                                                                ...
                                                                <div className='summary '>
                                                                    <div className='d-flex justify-content-between'>
                                                                        ...
                                                                        <div className='d-flex align-items-center'>
                                                                            ...
                                                                            <span className='wallet-currency'>{setting.setting && setting.setting.currency}   {(cart?.checkout?.sub_total)?.toFixed(setting.setting && setting.setting.decimal_point)}</span>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className='d-flex justify-content-between'>
                                                                        ...
                                                                        <div className='d-flex align-items-center'>
                                                                            ...
                                                                            <span className='wallet-currency'>{setting.setting && setting.setting.currency}  {(cart?.checkout?.delivery_charge?.total_delivery_charge)?.toFixed(setting.setting && setting.setting.decimal_point)}</span>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    {promoCode.code !== null && <>
                                                                        <div className='d-flex justify-content-between'>
                                                                            ...
                                                                            <div className='d-flex align-items-center'>
                                                                                <span className='wallet-currency'>- {setting.setting && setting.setting.currency}    {Number(promoCode.discount)?.toFixed(setting.setting && setting.setting.decimal_point)}</span>
                                                                            </div>
                                                                        </div>
                                                                    </>}
                                                                    {walletDeductionAmt ? <>
                                                                        <div className='d-flex justify-content-between'>
                                                                            ...
                                                                            <div className='d-flex align-items-center'>
                                                                                ...
                                                                                <span className='wallet-currency'>- {setting.setting && setting.setting.currency}    {Number(walletDeductionAmt)?.toFixed(setting.setting && setting.setting.decimal_point)}</span>
                                                                            </div>
                                                                        </div>
                                                                    </> : <></>}
                                                                    ...
                                                                    {loadingPlaceOrder
                                                                        ...
                                                                        : cartError !== "" ? <div className='warning-class'>
                                                                            <p className='checkout-warning-msg'><IoIosWarning size={40} className='me-3' />{cartError}</p>
                    ...
                    <Modal id="stripeModal" size='lg' centered show={stripeModalShow}>
                        <Modal.Header onClick={() => setStripeModalShow(false)
                            ...
                            <span style={{ color: '#33a36b', fontSize: '18px', fontWeight: 'bolder' }}>{process.env.NEXT_PUBLIC_WEB_NAME} Payment</span>
