...
import Popup from '../../../components/same-seller-popup/Popup';
...
const ProductDetails = () => {
    ...
    console.log("slug mill gya",slug);
            ...
            <Popover.Body className='ratingPopOverBody'>
                ...
                <div className='d-flex justify-content-start align-items-center gap-4'>
                    ...
                    <div className='d-flex gap-1'>
                        <img src={StarFilledSVG.src} alt='starLogo' loading='lazy' />
                    </div>
    ...
    return (
        <>
        <Head>
        <title> {productdata.name}- Kashmir Trout</title>
        </Head>
                ...
                <div className='product-details-view'>
                    <div id='productListingBreadcrumb' className='w-100 breadCrumbs'>
                        <div className='container d-flex align-items-center gap-2'>
                            ...
                            <div className='breadCrumbsItem'>
                                <Link className={pathname.split("/").findIndex(loc => loc == productdata?.slug) !== -1 ? "breadCrumbActive" : ""} href={location?.pathname}>{productdata?.name}</Link>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div className='top-section'>
                                                    ...
                                                    <div className='d-flex flex-column gap-2 align-items-start my-1'>
                                                        <div id="price-section" className='d-flex flex-row gap-2 align-items-center my-1'>
                                                            {setting.setting && setting.setting.currency}<p id='fa-rupee' className='m-0 fs-3'>{selectedVariant ? (selectedVariant.discounted_price == 0 ? selectedVariant.price.toFixed(setting.setting && setting.setting.decimal_point) : selectedVariant.discounted_price.toFixed(setting.setting && setting.setting.decimal_point)) : (productdata.variants[0].discounted_price === 0 ? productdata.variants[0].price.toFixed(setting.setting && setting.setting.decimal_point) : productdata.variants[0].discounted_price.toFixed(setting.setting && setting.setting.decimal_point))}</p>
                                                        </div>
                                                        {(selectedVariant?.price && (selectedVariant?.discounted_price !== 0)) && (selectedVariant?.price !== selectedVariant?.discounted_price) ?
                                                            <div>
                                                                <p className='fw-normal text-decoration-line-through wallet-currency' style={{ color: "var(--sub-text-color)", fontSize: "16px" }}>
                                                ...
                                                <div className='bottom-section'>
                                                    ...
                                                    {productdata?.indicator ?
                                                        productdata?.indicator == 1 ?
                                                            <div className='d-flex align-items-center mt-3'>
                                                                <img src={VegIcon.src} alt='vegIcon' className='me-3' />
                                                                <p className='veg-indicater'>{t("vegetarian")}</p>
                                                            </div>
                                                            :
                                                            <div className='d-flex align-items-center mt-3'>
                                                                <img src={NonVegIcon.src} alt='nonVegIcon' className='me-3' />
                                                    ...
                                                    {productdata?.cancelable_status == 1 ?
                                                        <div className='d-flex align-items-center mt-3 cancelContainer'>
                                                            <img src={Cancelable.src} alt='cancelableIcon' className='me-3' />
                                                        ...
                                                        :
                                                        <div className='d-flex align-items-center mt-3 cancelContainer'>
                                                            <img src={NonCancelable.src} alt='nonCancelableIcon' className='me-3' />
