...
import banner from "../../../public/productbanner.jpg"
...
// import "./product.css";
import CategoryComponent from '../../components/product/Categories';
import { MdSignalWifiConnectedNoInternet0 } from "react-icons/md";

import ProductCardss from '../../components/product/ProductCardss';
import ListViewCard from "../../components/product/ListViewCard"
...
const ProductList2 = React.memo(() => {
    ...
    const total_products_per_page = 27;
    console.log("in products list ",No_Orders)
    const dispatch = useDispatch();
    const navigate = useRouter();

    const closeCanvas = useRef();
    const category = useSelector(state => state.category?.category);
    console.log("categories in product page:::",category)
    const city = useSelector(state => state.city);
    const filter = useSelector(state => state.productFilter);
    const setting = useSelector(state => (state.setting));
    const user = useSelector(state => (state.user));
    console.log("filter in products page",filter)
    ...
    const Filter = () => {
        return (
            <>
                <Head>
                    <title>{t("product_category")}-Kashmir Trout</title>
                </Head>
    ...
    return (
                ...
                <>
                    {/* <div id='productListingBreadcrumb' className='w-100 breadCrumbs'>
                        <div className='container d-flex align-items-center gap-2'>
                            ...
                            <div className='breadCrumbsItem'>
                                <Link className={navigate.pathname === "/products" ? "breadCrumbActive" : ""} href={"/products"}>{t("products")}</Link>
                            </div>
                        </div>
                    </div> */}
                    <section id="productlist" className='container ' onContextMenu={() => { return false; }}>
                        ...
                        <div className='row justify-content-center' id='products'>
                            ...
                            <div className='d-flex flex-column w-100 h-100 productList_container' style={{ gap: '20px' }}>
      ...
      <div className="logo-containersss">
        ...
        <div className='logo-text-products'>OUR PRODUCTS</div>
      </div>
    </div>
         
        </div>
        {/* <div className="product-container">
          <Product src="https://placehold.co/300x200.png?text=Salmon+Fillet" alt="Salmon Fillet" />
          <Product src="https://placehold.co/300x200.png?text=Lemon" alt="Lemon" />
          <Product src="https://placehold.co/300x200.png?text=Seasoned+Salmon" alt="Seasoned Salmon" />
        </div> */}
      </section>
                                <div className="row">
                                                ...
                                                {productresult.length > 0 && isLoader == false
                                                    ...
                                                    : (
                                                        <div className='no-product'>
                                                            <img src={No_Orders.src} style={{ width: '40%' }} alt='no-product' className='img-fluid'></img>
                ...
                {/* <div class="card3">
  <img class="card-image3" src={banner2.src} alt="Cold Smoked Norwegian Atlantic Salmon" />
</div> */}
