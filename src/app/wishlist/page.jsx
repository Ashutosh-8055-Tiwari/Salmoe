...
import ImageWithPlaceholder from "../../components/image-with-placeholder/ImageWithPlaceholder.jsx";
...
const Wishlist = () => {
    ...
    return (
        <>
        <Head>
            <title>{t("wishList")} - Kashmirt Trout</title>
        </Head>
            {!isNetworkError ?
                <section id='wishlist' className='wishlist'>
                    {/* <div className='cover'>
                        ...
                        <div className='title'>
                            <h3>{t("wishList")}</h3>
                            <span><Link href='/' className='text-light text-decoration-none'>{t("home")} / </Link></span><span className='active'>{t("wishList")}</span>
                        </div>
                    </div> */}
                    ...
                    <div className='view-cart-container container'>
                        {favorite.favorite && favorite.favorite.status === 0 ? (
                            <div className='empty-cart'>
                                <img src={EmptyCart.src} className='no-data-img' alt='empty-cart'></img>
                                                                    ...
                                                                    {product?.variants?.length <= 1 && product?.variants?.[0]?.is_unlimited_stock == 0 && product?.variants?.[0]?.stock == 0 ?
                                                                        ...
                                                                        cart?.cartProducts?.find((prdct) => prdct?.product_variant_id == product?.variants?.[0]?.id)?.qty > 0 ?
                                                                            ...
                                                                            <>
                                                                                ...
                                                                                ><IoCartOutline fill='white' size={26}/></button></>}
