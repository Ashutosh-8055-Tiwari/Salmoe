                ...
                <div className="row ">
                                ...
                                : (
                                    <ul className='category-list '>
                                        {shop?.shop?.categories?.map((ctg, index) => (
                                            <li key={index}>
                                                <a className='link fs-6 cursor-pointer' onClick={() => {
                                                    selectCategory(ctg);
                    ...
                    >
                        ...
                        <ul className="link-list">
                            <li className='fs-6'><a href={`https://maps.google.com/?q=${setting.setting !== null ? setting.setting.store_address : "bhuj"}`} target='__blank'>{setting.setting !== null ? setting.setting.store_address : "address"}</a></li>
                            <li className='fs-6'><a href={`tel:${setting.setting !== null ? setting.setting.support_number : "number"}`}>{setting.setting !== null ? setting.setting.support_number : "number"}</a></li>
                            <li className='fs-6'><a href={`mailto:${setting.setting !== null ? setting.setting.support_email : "email"}`}>{setting.setting !== null ? setting.setting.support_email : "email"}</a></li>
                    ...
                    >
                        ...
                        <ul className="link-list" onClick={() => { window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
                            <li className='fs-6'><Link href={'/about-us'}>{t("about_us")}</Link></li>
                            <li className='fs-6'><Link href={'/faq'}>{t("faq")}</Link></li>
                            <li className='fs-6'><Link href={'/contact-us'}>{t("contact_us")}</Link></li>
                            <li className='fs-6'><Link href={'/terms'}>{t("terms_and_conditions")}</Link></li>
                            <li className='fs-6'><Link href={'/policy/Privacy_Policy'}>{t("privacy_policy")}</Link></li>
                            <li className='fs-6'><Link href={'/policy/ReturnsAndExchangesPolicy'}>{t("recharge_and_exchange_policy")}</Link></li>
                            <li className='fs-6'><Link href={'/policy/Shipping_Policy'}>{t("shipping_policy")}</Link></li>
                            <li className='fs-6'><Link href={'/policy/Cancellation_Policy'}>{t("cancellation_policy")}</Link></li>
                        </ul>
                    </div>
