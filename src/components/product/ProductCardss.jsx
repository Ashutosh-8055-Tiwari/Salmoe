...
const ProductCards = ({ product , isCartSidebarOpen, setIsCartSidebarOpen}) => {
    ...
    return (
        <div className='product-bg' >
            ...
            <div class="position-relative w-50 z-3">
  <div class=" bg-danger text-light px-3 py-1 rounded-end-pill  rounded-start-pill fs-6 mb-3 ">
    LIMITED EDITION
  </div>
</div>
                <div >
                    ...
                    <div className="new-product-image">
                        <a href={`${base_url}/products/${product.slug}`} className="image">
