                                    ...
                                    <div className='row body-wrapper'>
                                        <div className="col-xl-4 col-lg-6 col-md-12 col-12">
                                            <div className='image-wrapper'>
                                                <div className='main-image1 border'>
                                                ...
                                                <div className='sub-images-container row'>
                                                    {product.images.length >= 1 ?
                                                            ...
                                                            {product?.images?.map((image, index) => {
                                                                return (
                                                                    <SwiperSlide className='swiper-slide'>
                                                                        <div key={index} className={`sub-image1 ${mainimage == image ? 'active' : ''}`}>
                                                        ...
                                                        <>
                                                            {product.images.map((image, index) => (
                                                                <div key={index} className={`sub-image1 border ${mainimage === image ? 'active' : ''}`}>
                                                                    <img onError={placeHolderImage} src={image} className='col-12 ' alt="product" onClick={() => {
                                                                        setmainimage(image);
                                                                    }}></img>
                                                                </div>
                                            ...
                                            <div className='detail-wrapper'>
                                                <div className='top-section'>
                                                    ...
                                                    <div className="d-flex flex-row gap-2 align-items-center my-1">
                                                        ...
                                                        <div id="price-section-quickview" className='d-flex flex-row gap-2 align-items-center my-1 wallet-currency'>
                                                            {setting.setting && setting.setting.currency}
                                                            <p id='priceContainer' className='m-0 wallet-currency'>
                                                            ...
                                                            {(selectedVariant?.price && (selectedVariant?.discounted_price !== 0)) && (selectedVariant?.price !== selectedVariant?.discounted_price) ?
                                                                <p className='fw-normal text-decoration-line-through wallet-currency' style={{ color: "var(--sub-text-color)", fontSize: "16px", marginTop: "5px" }}>
                                                                    {setting.setting && setting.setting.currency}
                                                ...
                                                <div className='bottom-section'>
                                                    ...
                                                    <div className='share-product-container'>
                                                        ...
                                                        <ul className='share-product'>
                                                            <li className='share-product-icon'><WhatsappShareButton url={`${setting.setting && setting.setting.web_settings.website_url}products/${product.slug}`}><WhatsappIcon size={32} round={true} /></WhatsappShareButton></li>
                                                            <li className='share-product-icon'><TelegramShareButton url={`${setting.setting && setting.setting.web_settings.website_url}products/${product.slug}`}><TelegramIcon size={32} round={true} /></TelegramShareButton></li>
                                                            <li className='share-product-icon'><FacebookShareButton url={`${setting.setting && setting.setting.web_settings.website_url}products/${product.slug}`}><FacebookIcon size={32} round={true} /></FacebookShareButton></li>
                                                            <li className='share-product-icon'>
                                                                <button type='button' onClick={() => {
                                                                    navigator.clipboard.writeText(`${setting.setting && setting.setting.web_settings.website_url}products/${product.slug}`);
