                                        ...
                                        {cartSidebarData?.map((product, index) => (
                                            <div key={index} className='cart-card'>
                                                <div className='left-wrapper'>
                                                    <Link href={`${base_url}/products/${product.slug}`} onClick={() => {
                                                ...
                                                <div className='cart-card-end'>
                                                    <div className='d-flex flex-column align-items-center' style={{ fontSize: "14px", color: "var(--secondary-color)" }}>
                                                        <span id={`price${index}-cart-sidebar`} className='fs-5 wallet-currency'>
                                                        ...
                                                        {product?.price && product?.discounted_price !== 0 && product?.price !== product?.discounted_price ?
                                                            <span id={`price${index}-section`} className="d-flex align-items-center " >
                                                                <p id='relatedproduct-fa-rupee' className='fw-normal text-decoration-line-through m-0 wallet-currency' style={{ color: "var(--sub-text-color)", fontSize: "14px" }}>
                                                                    {setting?.setting && setting?.setting?.currency}
                                            ...
                                            {cart.cart && cart.promo_code ?
                                                <>
                                                    <div className="promo-code">
                                                        ...
                                                        <div className="d-flex flex-column">
                                                            <span className='wallet-currency'>{setting.setting && setting.setting.currency} {cart.promo_code.discount}</span>
                                            ...
                                            <>
                                                <div className='summary'>
                                                    <div className='d-flex justify-content-between'>
                                                        ...
                                                        <div className='d-flex align-items-center wallet-currency' style={{ fontSize: "14px" }}>
                                                            {setting.setting && setting.setting.currency}
                                                ...
                                                <div className='button-container'>
                                                    <button type='button' className='view-cart fs-6' onClick={() => {
                                                        closeCanvas.current.click();
                                                        navigate.push(`${base_url}/cart`);
                                                    }}>{t("view_cart")}</button>
                                                    <button type='button' className='checkout fs-6' onClick={() => {
                                                        if (cart?.isGuest) {
                                                            setShowModal(true)
