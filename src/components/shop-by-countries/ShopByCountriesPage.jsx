            ...
            <section className='allCountriesContainer'>
                <div className='cover'>
                    ...
                    <div className='page-heading'>
                        <h5>{t("countries")}</h5>
                        <p><Link href="/" className='text-light text-decoration-none'>{t("home")} /</Link> <span>{t("countries")}</span></p>
                    </div>
                </div>
                        ...
                        : <div className='row justify-content-center'>
                            {data?.map((country, index) => (
                                <div className="col-md-3 col-lg-2 col-6 col-sm-3  my-3 content" key={index} onClick={() => {
                                    ...
                                    <div className='card'>
                                        {/* <img onError={placeHolderImage} className='card-img-top' src={`${process.env.NEXT_PUBLIC_API_URL}/storage/${country.logo}`} alt='countryLogo' loading='lazy' /> */}
                                        <ImageWithPlaceholder className='card-img-top' src={`${process.env.NEXT_PUBLIC_API_URL}/storage/${country.logo}`} alt='countryLogo' />
