                        ...
                        <div className='row'>
                            <div className="col-md-12 col-12 d-flex justify-content-between align-items-center p-0">
                                <div className="title d-md-flex align-items-center ">
                                    ...
                                    <Link className='d-none d-md-block' href='/countries'>{t('see_all')} {t('countries')}<AiOutlineArrowRight size={15} className='see_countries_arrow' /> </Link>
                                </div>
                                <div className=' d-md-none'>
                                    <Link className='country_button' href='/countries'>{t('see_all')}</Link>
                                </div>
