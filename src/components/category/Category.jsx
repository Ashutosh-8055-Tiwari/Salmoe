...
const Category = () => {
    ...
    console.log("in categorry" , category)
                        ...
                        <div className='row'>
                            <div className="col-md-12 col-12 d-flex justify-content-between align-items-center p-0">
                                <div className="title d-md-flex align-items-center ">
                                    ...
                                    {/* <Link className='d-none d-md-block' href='/category/all'>{t('see_all')} {t('categories')}<AiOutlineArrowRight size={15} className='see_category_arrow' /> </Link> */}
                                </div>
                                <div className=' d-md-none'>
                                    {/* <Link className='category_button' href='/category/all'>{t('see_all')}</Link> */}
                                </div>
