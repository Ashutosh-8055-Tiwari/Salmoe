...
const CategoryChild = () => {
    ...
    useEffect(() => {
        if (!navigate.pathname.startsWith('/category/') || navigate.pathname === '/category/all') {
            ...
            {!isNetworkError ? <section id='allcategories'>
                <div className='cover'>
                    ...
                    <div className='page-heading'>
                        ...
                        <p>
                            <Link href="/" className='text-light text-decoration-none' onClick={() => fetchCategory(0)} key={"home"}>{t("home")} / </Link>
                            <Link href='/category/all' className='text-light text-decoration-none'
                                key={"category"}>{t("categories")} / </Link>
                            {SelectedCategory?.slug &&
                                <Link href={`/category/${SelectedCategory?.slug}`} className='text-light text-decoration-none' key={"categoryName"}>{SelectedCategory?.name} / </Link>
                            }
