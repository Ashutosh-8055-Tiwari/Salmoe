            ...
            <div className='row'>
              <div className="col-md-12 col-12 d-flex justify-content-between align-items-center p-0">
                <div className="title d-md-flex align-items-center ">
                  ...
                  <Link className='d-none d-md-block' href='/brands'>{t('see_all')} {t('brands')}<AiOutlineArrowRight size={15} className='see_brand_arrow' /> </Link>
                </div>
                <div className=' d-md-none'>
                  <Link className='brand_button' href='/brands'>{t('see_all')}</Link>
                </div>
