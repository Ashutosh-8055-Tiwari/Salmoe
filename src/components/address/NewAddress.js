...
const NewAddress = (props) => {
                ...
                .then(result => {
                    if (result.status === 1) {
                        ...
                        setaddressDetails({
                            ...
                            pincode: '',
                            state: '',
                            country: 'India', // Maintain India as default country when resetting form
                            address_type: 'Home',
                            is_default: false,
                        });
    ...
    useEffect(() => {
        if (props.isAddressSelected && address.selected_address) {
            setaddressDetails({
                ...
                country: address.selected_address.country || 'India', // Default to India if not provided
        ...
        geocoder.geocode({
            ...
            .then(response => {
                if (response.results[0]) {
                    ...
                    let address = '', country = 'India', pincode = '', landmark = '', area = '', state_ = '', city = '';
    ...
    const handlePlaceSelect = (place) => {
        ...
        console.log(place);  // Logs the place object
      };
                    ...
                    <div className="flex d-lg-flex flex-row gap-5">
                        <div className='w-100 mapWrapper'>
                            <button whiletap={{ scale: 0.6 }} className="current-location-button"
                                ...
                                <BiCurrentLocation className='' width="40px" height="40px" />
                            </button>
                            <LoadScript
                                    ...
                                    <form onSubmit={(e) => { e.preventDefault(); handleConfirmAddress(); }} className='address-details-wrapper'>
                                        ...
                                        <div className='address-detail-container'>
                                            ...
                                            <div className='address-details'>
                                                ...
                                                }} required ></input> {/* Removed required attribute */}
