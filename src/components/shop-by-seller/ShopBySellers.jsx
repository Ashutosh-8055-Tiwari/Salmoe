                    ...
                    <div className="row seller_section_header">
                        <div className="col-md-12 col-12 d-flex justify-content-between align-items-center p-0">
                            <div className="title d-md-flex align-items-center ">
                                ...
                                <Link className='d-none d-md-block' href='/sellers'>{t('see_all')} {t('sellers')}<AiOutlineArrowRight size={15} className='see_sellers_arrow' /> </Link>
                            </div>
                            <div className=' d-md-none'>
                                <Link className='seller_button' href='/sellers'>{t('see_all')}</Link>
                            </div>
