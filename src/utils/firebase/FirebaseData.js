...
const FirebaseData = () => {
  ...
  const apiKey =  "AIzaSyC1QYr5YZKFgG6LasUdREB8WJN2MWlbEB4" ;
  const authDomain =  "kashmirtrout-62b7b.firebaseapp.com" ;
  const  projectId =  "kashmirtrout-62b7b" ;
  const storageBucket =  "kashmirtrout-62b7b.firebasestorage.app" ;
  const  messagingSenderId =  "295711060922" ;
  const appId =  "1:295711060922:web:4fb70d21023717a18ca383" ;
  const measurementId =  "G-XQKZBRF7FE" ;
